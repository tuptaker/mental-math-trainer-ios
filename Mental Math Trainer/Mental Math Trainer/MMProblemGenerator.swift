...
class MMProblemGenerator {
    ...
    private func generateLecture1Problem() -> MMProblem {
        // There are 6 types of problem in Lecture 1, so we have to
        // randomely generate one of the 6 problems.
        
        var problem = MMProblem(expressionText: "", solution: 0.0)
        let lecture1ProblemType = arc4random_uniform(1) + 1
        ...
        case 1:
            ...
            problem = MMProblem(expressionText: expression, solution: Float(result))
        case 2:
            /*
             ...
             */
            problem = MMProblem(expressionText: "", solution: 0.0)
        case 3:
            /*
